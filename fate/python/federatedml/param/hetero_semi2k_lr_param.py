...
class Semi2kLogisticRegressionParam(BaseParam):
    """
    ...
    def __init__(self, penalty=None,
                 ...
                 host_address_port = "192.168.179.162",
                 guest_address_port = "192.168.179.161"
                 ):
        super(Semi2kLogisticRegressionParam, self).__init__()
        ...
        self.host_address_port = host_address_port
        self.guest_address_port = guest_address_port
    ...
    def check(self):
        ...
        if type(self.host_address_port).__name__!= "str":
            raise ValueError(
                "host_address_port {} not supported, should be str type".format(self.host_address_port))
            
        if type(self.guest_address_port).__name__!= "str":
            raise ValueError(
                "guest_address_port {} not supported, should be str type".format(self.guest_address_port))
