...
from federatedml.optim.gradient.cheetah_hetero_linr_gradient_and_loss import cheetah_matmul_server,cheetah_matadd,cheetah_matsub,intermidiate,variables,cheetah_fit
...
class HeteroLinRGuest(HeteroLinRBase):
    ...
    def fit(self, data_instances, validate_data=None):
        ...
        # self.ori_fit(self, data_instances=data_instances)
    ...
    def ori_fit(self, data_instances, validate_data=None):
        ...
        while self.n_iter_ < self.max_iter:
            ...
            for batch_data in batch_data_generator:
                ...
                forwards = cheetah_matmul_server(data_instances, self.model_weights.coef_, bias, True)
                ...
                intermidiate(self, batch_index, batch_data, optim_guest_gradient)
