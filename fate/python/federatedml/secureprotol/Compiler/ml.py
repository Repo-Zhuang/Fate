...
class Optimizer:
    ...
    def __init__(self, layers=[], report_loss=None, tol=0.000):
...
class SGD(Optimizer):
    ...
    """
    def __init__(self, layers, n_epochs=1, debug=False, report_loss=None, learning_rate=0.01, tol = 0.000):
        super(SGD, self).__init__(report_loss=report_loss, tol = tol)
        self.momentum = 0.9
        self.layers = layers
        self.n_epochs = n_epochs
        self.nablas = []
...
class OneLayerSGD:
    def __init__(self, n_epochs=1, batch_size=1, program=None, learning_rate= 0.01, tol =0.000):
        self.n_epochs = n_epochs
        self.batch_size = batch_size
    ...
    def fit(self, X_train, y_train):
        ...
        """
        self.init(X_train, learning_rate = self.learning_rate, tol = self.tol)
...
class SGDLogistic(OneLayerSGD):
    ...
    def init(self, X, learning_rate = 0.01, tol =0.000):
        ...
        if self.program:
            ...
            print(1)
            self.opt = SGD([dense, sigmoid], 1, learning_rate = learning_rate, tol = tol)
