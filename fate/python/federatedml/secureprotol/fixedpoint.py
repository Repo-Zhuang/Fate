...
class FixedPointNumber(object):
    ...
    #         if int_fixpoint > max_int:
    #             int_fixpoint -= n
    #         elif int_fixpoint < -max_int:
    #             int_fixpoint += n
    ...
    #     return cls(int_fixpoint, exponent, n, max_int)
    def encode(cls, scalar, n=None, max_int=None, precision=None, max_exponent=None):
    ...
    def decode(self):
        ...
        # Ensure encoding is within the valid range by taking modulo n
        self.encoding = self.encoding % self.n
