...
def hello_world(): 
    ...
    data1 = np.loadtxt('./breast_hetero_guest.csv', delimiter=',', skiprows=1)
    data2 = np.loadtxt('./breast_hetero_host.csv', delimiter=',', skiprows=1)
    data1 = data1[:, 1:]
    data2 = data2[:, 1:]
    ...
    X_train_guest = sfix.input_tensor_from(1, (569,10))
    s = X_train_guest[2]
